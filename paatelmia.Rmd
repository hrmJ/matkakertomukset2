...
Tarkastelimme tässä tutkimuksessa tekstikappaleen sisältötopiikin muodostumista korpusvetoisesti kahdella menetelmällä, ja tavoitteenamme oli selvittää, millaisia tapoja yliopisto-opiskelijat käyttävät saman topiikin asettamiseen ja miten näitä tapoja voidaan määritellä toisaalta funktionaalisesti, toisaalta syntaktisesti. 
