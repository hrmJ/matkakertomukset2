...
Taulukon mukaan ryhmä @ee_lista voidaan rakenteiden tasolla määritellä siten, että
siinä on nominaalinen topiikki-indikaattori, jonka pääverbi esiintyy ensimmäisessä
persoonassa ja imperfektissä. Ryhmän @ee_omakokemus puolestaan erottaa 
muista se, että asumisaiheeseen viitataan siinä jollakin kompleksisella
lausekkeella, kuten *asunnon hankinta* tai *asumisen järjestäminen*. Ryhmä @ee_ennakoivat
taas voidaan määritellä ennen kaikkea aikamuodon pohjalta: siihen 
kuuluvat tapaukset, joissa verbi on pluskvamperfektissä.
Ainoastaan ryhmien @ee_narratiivi, @ee_parisanaa ja @ee_valimaasto  osalta ei tässä esitetyn
...
että esimerkin sijoittaminen ryhmään @ee_linkki on perustunut täysin 
