...
Tekstin kokonaisrakenne tällä, kuten usealla muullakin aineiston kirjoittajalla, on Vuorijärven termiä käyttäen topiikkipohjainen. Raportissa käsitellään sisältö topiikki kerrallaan, eivätkä nämä sekvenssit ole hierarkkisessa suhteessa keskenään. (ks. myös Komppa). JA TULISIKO TÄHÄN LINKKI YLEISKUVAN TULOKSII, ELI ETTÄ USEIN LAUSEENALKUINEN OBJEKTI ON SE SYNTAKTINEN RAKENNE, JOTA HYÖDYNNETÄÄN?




Hiearkkisen rakenteen sijaan aienistosta löytyy kuitenkin kirjoittajia, jotka rakentavat tekstinsä temporaalisten sekvenssien avulla. Tämän strategian käyttö luo raporttin narratiivin.
