...
Koska tutkimuksen tavoitteena oli nimenomaan mahdollisimman monen erilaisen 
indikointitavan kartoittaminen, haluttiin myös satunnaisotoksesta saada
rakenteeltaan niin heterogeeninen kuin mahdollista. Tämän mahdollistamiseksi
otoksen lähdettä (kaikki `r nrow(withindicator)` tekstiä kattava korpus) 
annotoitiin ensin automaattisesti niin pitkälle kuin mahdollista. 
Tämä 
