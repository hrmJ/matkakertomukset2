...
Tutkimuksen aineisto koostuu siis yliopisto-opiskelijoiden
vaihtokokemuksestaan kirjoittamista matkakertomuksista.
Kirjoittajien tehtävänä on ollut laatia kuvaileva ja arvioiva
teksti, ja tehtävään on annettu melko tarkka ohjeistus, joka
koostuu kahdeksasta eri alakohdasta (mm. *etukäteisjärjestelyt*,
*asuminen* ja *merkityksellisyys*). (jotain arvioivaa siitä, miten
ohjeet ehkä vaikuttaneet).

Aineistoon valikoituneista teksteistä..
